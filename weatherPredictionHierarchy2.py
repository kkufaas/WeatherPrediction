...
def set_cpds():
    ...
    precipitation_cpd = TabularCPD(variable='precipitation', variable_card=3, evidence=['wind'], evidence_card=[3],
                                   values=cpd_lst[1],
                                   state_names={'precipitation': precipitation_states, 'wind': wind_states})
    ...
    temp_min_cpd = TabularCPD(variable='temp_min', variable_card=3, evidence=['precipitation'], evidence_card=[3],
                              values=cpd_lst[3], state_names={'temp_min': temp_min_states, 'precipitation': wind_states})
...
def perform_inference(model):
    ...
    # Dynamically find the index for 'high' wind
...
if __name__ == "__main__":
    ...
    # Task 1.3 question 4
    # Please note this function works in 50% cases. If it shows some kind of Nan error,
